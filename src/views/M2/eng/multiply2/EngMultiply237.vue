...
<ul>
	<li class="nobreak-final-final"><span class="for-enrichment">For Further Study: <span class="popup-link" @click = "popUp('pop3')"> Mark 6:45-52</a</span>bsp;</span>
	...
	<span class="for-enrichment"><span class="popup-link" @click = "popUp('pop4')"> John 6:16-21</a</span>span>
