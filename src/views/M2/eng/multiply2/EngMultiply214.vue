...
<ul>
	<li class="nobreak-final-final"><span class="for-enrichment">Further Study: <span class="popup-link" @click = "popUp('pop3')"> Matthew 4:17</a</span>/span>
	...
	<span class="for-enrichment"> &nbsp;<span class="popup-link" @click = "popUp('pop4')"> Mark 1:14-15</a</span>bsp; </span>
	...
	<span class="for-enrichment"> <!-- end bible --></span></div>
	<span class="for-enrichment"><span class="popup-link" @click = "popUp('pop5')"> Luke 4:14-15</a</span>bsp; </span>
