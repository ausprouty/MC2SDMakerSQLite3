...
<ul>
	<li class="nobreak-final-final">Read <span class="popup-link" @click = "popUp('pop3')"> Hebrews 5:8-9</a</span>bsp;
	...
	<!-- end bible --></div>
	We don&rsquo;t have a lot of information about Jesus&rsquo; teenage life, but we can assume he grew up in normal Jewish conditions. He was the oldest brother of a large family (<span class="popup-link" @click = "popUp('pop4')"> Mark 6:3</a</span>nbsp;
	...
	<!-- end bible --></div>
	He would have joined Joseph learning the family trade of being a builder. The bible says that just like us &ldquo;He learned obedience&rdquo; (<span class="popup-link" @click = "popUp('pop5')"> Hebrews 5:8</a</span>nbsp;
