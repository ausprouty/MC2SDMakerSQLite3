...
<ul>
	<li class="nobreak-final-final"><span class="for-enrichment">Further Study: <span class="popup-link" @click = "popUp('pop3')"> Luke 4:38-44</a</span>
...
<span class="popup-link" @click = "popUp('pop4')"> Matthew 8:14-17</a</span>
